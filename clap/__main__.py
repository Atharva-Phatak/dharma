...
from clap.deploy_infra import InfraDeployer
...
app = typer.Typer(
    name="clap",
    help="👏 Clap - CLI to deploy infrastructure and pipelines",
    rich_markup_mode="rich",
)

console = Console()
UPLOAD_CHOICES = ["states", "model", "optimizer", "schedulers", "all"]


@app.command()
def infra_action(
    group_name: str = typer.Option(
        "...", "--group_name", help="Name of the infrastructure stack"
    ),
