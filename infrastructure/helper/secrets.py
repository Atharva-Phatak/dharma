...
def generate_grafana_credentials(
    project_id: str,
    environment_slug: str,
):
    grafana_username = os.getenv("GRAFANA_USERNAME")
    grafana_password = os.getenv("GRAFANA_PASSWORD")
    grafana_username = create_infiscal_secret(
        project_id=project_id,
        environment_slug=environment_slug,
        secret_name="grafana_username",
        secret_value=grafana_username,
    )
    grafana_password = create_infiscal_secret(
        project_id=project_id,
        environment_slug=environment_slug,
        secret_name="grafana_password",
        secret_value=grafana_password,
    )
